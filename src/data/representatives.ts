...
"Fortalecimiento de la carrera docente mediante el apoyo a los procesos de ratificación, promoción y ascenso"
  ...
  },
  {
    ...
    fullBio: "Profesor Principal de Inmunología Veterinaria en la UNC, PhD por la Universidad de Liverpool, Inglaterra. \nInvestigador RENACYT nivel Distinguido. \nDirector del “Centro de Investigación en Medicina Tropical” de la UNC. Su trayectoria abarca la investigación en fascioliasis humana y animal, inmunología, parasitología, diagnóstico, epidemiología y resistencia antihelmíntica, con proyectos nacionales e internacionales y trabajo en equipos multidisciplinarios. \nActualmente es investigador asociado en proyectos financiados con fondos internacionales. \nEs revisor par de revistas científicas internacionales como: Veterinary Parasitology, Acta Tropica, Veterinary Research Communications, \nExperimental Parasitology, Parasitology Research y Veterinary and Animal Science. \nSu producción científica incluye 47 publicaciones, con un índice h de 17 y 903 citas en Scopus, indicadores que reflejan la continuidad, visibilidad e impacto de sus aportes científicos. Esta trayectoria sustenta una propuesta orientada a fortalecer la investigación, la innovación tecnológica, el emprendimiento y la responsabilidad social universitaria como funciones estratégicas para el desarrollo de la UNC y de la región Cajamarca. \nEvaluador de proyectos de investigación de la Universidad Nacional Mayor de San Marcos. \nHa recibido diversos reconocimientos por su labor investigativa, entre ellos distinciones de la \nEditorial Elsevier, del Congreso de la República del Perú y del Colegio Médico Veterinario del Perú. \nMiembro de la “World Association for the Advancement of Veterinary Parasitology” (WAAVP). \nMiembro de la “American Society of Tropical Medicine and Hygiene” (ASTMH). \nDirectivo de la Asociación Peruana de Parasitología.",
    proposals: [
