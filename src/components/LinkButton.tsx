...
export default function LinkButton({ link, size = "sm" }: Props) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center rounded-full border border-primary bg-white text-primary font-medium transition-colors hover:bg-primary/10 ${sizes[size]}`}
    >
