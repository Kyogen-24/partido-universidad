    ...
    >
      ...
      >
        {posts.map((post, i) => (
          <div
            ...
            className="w-[200px] shrink-0 snap-start select-none overflow-hidden rounded-2xl border border-white/15 bg-white/10 backdrop-blur-sm sm:w-[calc((100%-32px)/3)] lg:w-[calc((100%-64px)/5)]"
          >
      ...
      {maxSlide > 0 && (
        <>
          <button
            onClick={goPrev}
            className="absolute -left-4 top-1/2 hidden -translate-y-1/2 rounded-full bg-white/10 p-2 text-white/70 backdrop-blur-sm transition-all hover:bg-white/20 hover:text-white sm:-left-6 sm:flex lg:hidden"
            aria-label="Anterior"
          >
          ...
          <button
            onClick={goNext}
            className="absolute -right-4 top-1/2 hidden -translate-y-1/2 rounded-full bg-white/10 p-2 text-white/70 backdrop-blur-sm transition-all hover:bg-white/20 hover:text-white sm:-right-6 sm:flex lg:hidden"
            ...
            {Array.from({ length: maxSlide + 1 }).map((_, i) => (
              <button
                ...
                className={`h-1.5 rounded-full transition-all ${
                  i === currentSlide ? "w-5 bg-white/70" : "w-1.5 bg-white/25 hover:bg-white/40"
                }`}
